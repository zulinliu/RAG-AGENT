...
async def upload_document(
    ...
    try:
        from app.tasks.sync import process_uploaded_document
...
async def get_document_stats(
    ...
    svc = DocumentService(db)
    return await svc.get_document_stats(uuid.UUID(project_id))
...
def _document_to_response(doc: Any) -> DocumentResponse:
    ...
    return DocumentResponse(
        ...
        file_type=doc.file_type if hasattr(doc, "file_type") else (doc.source_type or ""),
